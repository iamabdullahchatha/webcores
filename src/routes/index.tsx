...
function StatCard({ s, delay }: StatCardProps) {
  ...
  const count = useCountUp(numericVal, prefersReduced ? 0 : 1800, inView);
  ...
  return (
    <motion.div
      ...
      whileHover={prefersReduced ? undefined : { y: -6, scale: 1.04 }}
...
function Index() {
  ...
  const displayedFaqs =
    activeCategory !== null ? (faqCategories[activeCategory]?.faqs ?? []) : allFaqs;
  ...
  return (
    <Layout>
      ...
      <section ref={heroRef} className="relative overflow-hidden min-h-screen flex items-center">
        ...
        <motion.div
          animate={prefersReduced ? undefined : { scale: [1, 1.18, 1], opacity: [0.25, 0.55, 0.25] }}
        ...
        />
        <motion.div
          animate={prefersReduced ? undefined : { scale: [1, 1.25, 1], opacity: [0.15, 0.35, 0.15] }}
        ...
        />
        <motion.div
          animate={prefersReduced ? undefined : { scale: [1, 1.1, 1], opacity: [0.08, 0.18, 0.08] }}
            ...
            >
              ...
              >
                {statsLoading
                  ...
                  : stats.map((s, i) => <StatCard key={s.l} s={s} delay={0.6 + i * 0.08} />)}
              </motion.div>
            </motion.div>
          </div>
        </motion.div>
          ...
          [
            ...
            <div key={ri} className={`relative ${ri === 1 ? "mt-5" : ""}`}>
              ...
              <motion.div
                ...
                animate={prefersReduced ? undefined : { x: row.dir === 1 ? ["0%", "-50%"] : ["-50%", "0%"] }}
                transition={{
                  duration: row.speed,
                  repeat: Infinity,
                  repeatType: "loop",
        ...
        <motion.div {...scaleIn(0.1)} className="relative glass rounded-3xl p-12 overflow-hidden">
          ...
          <div className="relative flex flex-wrap justify-center gap-4 md:gap-5">
            {regions.map((r, i) => (
              <motion.div
                key={r.name}
                initial={prefersReduced ? false : { opacity: 0, scale: 0.6, y: 16 }}
                ...
                whileHover={prefersReduced ? undefined : { y: -6, scale: 1.06 }}
      ...
      <section aria-hidden="true" className="sr-only">
        <h2>Web Development &amp; SEO Agency in Dubai — Webcore Solutions</h2>
        ...
        <ul>
          <li>
            Web Development — custom, performance-first websites built for conversion and scale.
          </li>
          <li>
            Software Development — bespoke applications, SaaS platforms, and business automation.
          </li>
          <li>
            CMS Development — headless and traditional CMS builds on WordPress, Sanity, and more.
          </li>
          <li>
            SEO and GEO Optimization — technical SEO, content strategy, and AI-search visibility.
          </li>
          <li>Graphic Design — brand identity, UI/UX design, and visual systems.</li>
          <li>
            IT Consultation — architecture reviews, cloud strategy, and fractional CTO services.
          </li>
        </ul>
        ...
        <p>
          ...
          forward — regardless of whether you choose to engage us. Zero obligation, replies within
          one business day, and entirely free of charge.
        </p>
      </section>
    </Layout>
  );
