...
export const Route = createFileRoute("/services/graphic-design")({
  head: () => getSeoHead("graphicDesign", { faqs }),
...
/* ─── Graphic Design Overview (image section) ───────────────────────── */
function GraphicDesignOverview() {
  return (
    <section className="mx-auto max-w-7xl px-4 pt-14 pb-8">
      <div className="grid md:grid-cols-2 gap-12 lg:gap-20 items-center">
        ...
        >
          <SectionLabel>Our Creative Craft</SectionLabel>

          <h2 className="text-3xl md:text-[2.25rem] font-bold leading-tight mb-5">
            Design that earns trust{" "}
            <span className="gradient-text">at first glance.</span>
          </h2>

          <p className="text-muted-foreground text-sm leading-relaxed mb-8 max-w-md">
            Every brand we build starts with strategy and ends with a system — not just
            a logo. We create visual identities that are distinctive, consistent and built
            to work everywhere your business shows up.
          </p>
            ...
            {[
              {
                ...
                sub: "Every file, every mark, every asset belongs to you outright — no licensing fees or lock-in, ever",
              },
              {
                icon: Sparkles, color: "#8b5cf6",
                label: "3 distinct creative concepts per project",
                sub: "We present three fully developed directions so you can choose the route that best fits your vision",
              },
              {
                icon: Package, color: "#06b6d4",
                label: "Print-ready source files included",
                sub: "Figma, .AI, .PSD, .EPS and print-optimised PDFs — every format you'll ever need, handed over on delivery",
              },
            ].map((item, i) => (
              <motion.li
                key={item.label}
        ...
        >
          ...
          <div
            ...
            style={{
              background: "radial-gradient(ellipse 80% 70% at 55% 45%, rgba(236,72,153,0.12) 0%, transparent 72%)",
              filter: "blur(24px)",
            }}
          />
          ...
          >
            ...
            <div className="relative overflow-hidden" style={{ aspectRatio: "4 / 3" }}>
              <img
                src={imgGraphics1}
                alt="Creative design team crafting a brand identity system"
              ...
              <div
                className="absolute inset-0 pointer-events-none"
                style={{
                  background: "linear-gradient(130deg, rgba(236,72,153,0.20) 0%, transparent 48%)",
                }}
              />
              ...
              >
                ...
                <span className="text-[10px] font-semibold text-white/80 tracking-wide">Full IP transfer</span>
              </motion.div>
              ...
              <motion.div
                ...
                className="absolute bottom-3.5 left-3.5 flex items-center gap-2 rounded-md px-3 py-1.5 backdrop-blur-md border border-pink-400/30"
                style={{ background: "rgba(100,20,80,0.48)" }}
              >
                <Palette className="h-2.5 w-2.5 text-pink-300 shrink-0" />
