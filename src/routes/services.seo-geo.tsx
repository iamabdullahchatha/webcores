...
export const Route = createFileRoute("/services/seo-geo")({
  head: () => ({
    meta: [
      { title: "SEO & GEO — Webcore Solutions" },
      { name: "description", content: "Rank higher locally and globally — organically and sustainably." },
    ],
  }),
  component: SeoGeo,
});
  ...
  return (
    <Layout>
      <section ref={heroRef} className="relative overflow-hidden min-h-[78vh] flex items-center">
        ...
        <motion.div animate={{ scale: [1, 1.3, 1], opacity: [0.06, 0.14, 0.06] }} transition={{ duration: 11, repeat: Infinity, ease: "easeInOut", delay: 1.5 }} className="absolute top-1/3 left-1/4 rounded-full pointer-events-none" style={{ width: 280, height: 280, background: "radial-gradient(circle, #10b981 0%, transparent 70%)" }} />
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <motion.div initial={{ opacity: 0, scale: 0.88 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.5, delay: 0.08, type: "tween", ease: [0.22, 1, 0.36, 1] }} className="inline-flex items-center gap-2 glass rounded-full px-4 py-1.5 text-xs font-semibold mb-7">
                  <Search className="h-3.5 w-3.5 text-primary" />SEO &amp; GEO
                </motion.div>
                ...
                <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.38, type: "tween", ease: "easeOut" }} className="mt-7 flex flex-wrap gap-2.5">
                  {[{ icon: Shield, label: "White-hat methodology" }, { icon: Clock, label: "First wins in 60 days" }, { icon: TrendingUp, label: "Avg. 3× traffic increase" }].map((p) => (
      ...
      <section className="mx-auto max-w-7xl px-4 py-24">
        <motion.div {...fadeUp()} className="mb-14">
          ...
          <div className="flex items-end justify-between flex-wrap gap-4">
            <h2 className="text-4xl md:text-5xl font-bold">Every SEO capability,<br />under one roof.</h2>
            <p className="text-muted-foreground max-w-sm text-sm leading-relaxed">From foundational technical fixes to full content and link-building campaigns — we cover the entire organic growth stack in-house.</p>
          </div>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <motion.div {...fadeUp(0.1)}>
            <div className="glass border border-border/35 rounded-2xl p-8 h-full">
              ...
              <p className="text-sm text-muted-foreground mb-7 leading-relaxed">Every insight we share is backed by data from the tools professionals trust — so you're never flying blind on your organic performance.</p>
              ...
              <div className="mt-8 flex items-start gap-3 p-4 bg-primary/5 border border-primary/15 rounded-xl">
                ...
                <p className="text-xs text-muted-foreground leading-relaxed"><span className="text-foreground font-semibold">100% white-hat methodology.</span>{" "}No link farms, no paid placements, no black-hat shortcuts — only sustainable techniques that compound in value over time and never put your domain at risk.</p>
              </div>
            </div>
          </motion.div>
        </div>
      ...
      <section className="mx-auto max-w-7xl px-4 py-20">
        <motion.div {...fadeUp()} className="text-center max-w-2xl mx-auto mb-18">
          ...
          <h2 className="text-4xl md:text-5xl font-bold">From audit to authority —<br />five clear steps.</h2>
          <p className="mt-4 text-muted-foreground text-sm">A structured SEO process refined across 200+ organic growth engagements.</p>
        </motion.div>
        <div className="relative">
      ...
      <section className="mx-auto max-w-4xl px-4 py-16">
        <motion.div {...fadeUp()} className="text-center mb-12">
          ...
          <h2 className="text-4xl md:text-5xl font-bold">Common questions<br />about SEO &amp; GEO.</h2>
      ...
      <section className="mx-auto max-w-5xl px-4 py-10 pb-28">
        <motion.div {...fadeUp()} className="relative overflow-hidden rounded-2xl gradient-primary shadow-elegant">
          <div className="absolute inset-0 pointer-events-none overflow-hidden">
            <svg className="absolute inset-0 w-full h-full opacity-[0.06]" xmlns="http://www.w3.org/2000/svg"><defs><pattern id="cta-grid-seo" width="32" height="32" patternUnits="userSpaceOnUse"><path d="M 32 0 L 0 0 0 32" fill="none" stroke="white" strokeWidth="0.5" /></pattern></defs><rect width="100%" height="100%" fill="url(#cta-grid-seo)" /></svg>
          ...
          <div className="relative flex flex-col md:flex-row items-center justify-between gap-8 px-8 py-10 md:px-12">
            <div className="flex-1 text-left">
              <div className="inline-flex items-center gap-1.5 bg-white/15 rounded-full px-3 py-1 text-[10px] font-bold uppercase tracking-widest text-white/70 mb-4"><Search className="h-3 w-3 text-emerald-300" />Free SEO audit</div>
              <h2 className="text-2xl md:text-3xl font-bold text-white leading-snug">Ready to build organic visibility<br className="hidden md:block" /> that compounds for years?</h2>
              <p className="text-white/60 text-sm mt-2.5 leading-relaxed max-w-sm">Book a free 45-minute discovery call. We'll audit your current SEO health and map out the highest-impact opportunities.</p>
              <div className="flex items-center gap-6 mt-5">
                {[{ v: "200+", l: "Sites ranked" }, { v: "60d", l: "First wins" }, { v: "100%", l: "White-hat only" }].map((s) => (
