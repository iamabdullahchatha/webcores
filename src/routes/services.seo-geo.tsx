...
const features = [
  ...
  },
  {
    ...
    t: "Local & GEO SEO",
    d: "Google Business optimisation, citation building, geo-targeted landing pages and multi-location strategies for businesses that win locally.",
  },
  {
    icon: Link2,
    color: "#8b5cf6",
...
const testimonials = [
  {
    ...
    quote: "Within 90 days our organic leads doubled. Webcore's SEO strategy is the highest-ROI investment we've made as a business.",
  ...
  },
  {
    name: "Sarah Lin",
    role: "CTO, NorthPeak",
    quote: "The technical audit alone uncovered issues that had been suppressing our rankings for years. The roadmap they delivered was clear, actionable and right.",
  ...
  },
  {
    ...
    quote: "Our local GEO strategy now puts us at the top of maps results in all three cities we operate in. The results speak for themselves.",
  ...
  return (
    <Layout>
      ...
      <section ref={heroRef} className="relative overflow-hidden min-h-[78vh] flex items-center">
        ...
        {/* Emerald accent for SEO/growth theme */}
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <motion.p initial={{ opacity: 0, y: 14 }} animate={{ opacity: 1, y: 0 }}
                  ...
                  Technical SEO, content strategy, local GEO and authority-building —
                  engineered to drive sustainable organic growth that pays for itself for years.
                </motion.p>
