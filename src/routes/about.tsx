  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <ChevronDown
            className={`h-4 w-4 transition-colors ${open ? "text-primary-foreground" : "text-primary"}`}
          />
        </motion.div>
      </button>
      <AnimatePresence>
  ...
  return (
    <Layout>
        ...
        <motion.div style={{ y: heroY, opacity: heroOpacity }} className="relative w-full">
          <div className="mx-auto max-w-7xl px-4 pt-20 pb-28 md:pt-24 md:pb-32">
            <div className="flex flex-col items-center text-center">
              ...
              >
                Dubai digital agency <span className="gradient-text">built on craft.</span>
              </motion.h1>
              ...
              >
                Born in Dubai, made for the world. Webcore Solutions is a digital agency that
                partners with ambitious teams to design and ship premium digital products — software
                that is beautiful, fast, and built to endure.
              </motion.p>
              ...
              <TiltCard key={s.l}>
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      background: `linear-gradient(to right, transparent, ${s.color}66, transparent)`,
                    }}
                  />
                </motion.div>
              </TiltCard>
          ...
          <motion.div {...fadeUp()}>
            ...
            <div className="space-y-4 text-muted-foreground leading-relaxed">
              <p>
                ...
                Webcore Solutions began with a simple belief: that great software is the result of
                great craft.
              </p>
              <p>
                We started as a small team of three, focused on delivering web solutions to regional
                businesses who deserved better than what the market was offering. We obsessed over
                details others ignored — performance, accessibility, maintainability.
              </p>
              <p>
                Over a decade later, we serve clients across Dubai, the UAE, the UK, Europe, America
                and Pakistan — building everything from custom software to e-commerce platforms,
                brand systems, and growth engines. The team is bigger, the work is more complex, but
                ...
                >
                  ...
                  >
                    ...
                    <div
                      ...
                      style={{
                        background: `linear-gradient(to right, ${item.color}88, transparent)`,
                      }}
                    />
                  </div>
                </motion.div>
            ...
            <TiltCard key={v.t}>
              ...
              >
                ...
                <div
                  className="absolute bottom-0 left-0 right-0 h-0.5 scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-center"
                  style={{
                    background: `linear-gradient(to right, transparent, ${v.color}66, transparent)`,
                  }}
                />
              </motion.div>
            </TiltCard>
      ...
      <section className="mx-auto max-w-7xl px-4 py-16">
        <motion.div
          {...fadeUp()}
          className="glass rounded-3xl p-10 md:p-14 overflow-hidden relative"
        >
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="text-muted-foreground text-sm leading-relaxed">
                Whether you need a single service or an end-to-end digital partner, we deliver every
                discipline in-house — no outsourcing, no middlemen.
              </p>
              <Link
                to="/services"
      ...
      <section className="mx-auto max-w-4xl px-4 py-16 pb-24">
        ...
        >
          ...
          <p className="text-sm text-muted-foreground leading-relaxed italic">
            Webcore Solutions is a Dubai, United Arab Emirates company, headquartered in Dubai since
            2012. We are not affiliated with similarly-named businesses based in Pakistan, India,
            the United Kingdom, or the United States. All projects, team members, testimonials, and
            case studies referenced on this site were delivered by the Dubai team led by Muhammad
            Abdullah Chattha. Official contact channels: +971 50 716 9200 (Dubai), +44 7570 792516
            (UK), info@webcoreuae.com.
          </p>
        </motion.div>
          ...
          <div className="glass rounded-3xl p-10 relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <p className="text-muted-foreground text-sm mb-6 max-w-sm mx-auto">
                Get the senior team on a free 45-minute call — honest answers on scope, timeline and
                budget, no sales script.
              </p>
              <Link
                to="/contact"
