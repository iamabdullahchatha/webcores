...
const features = [
  {
    ...
    t: "Business Websites",
    d: "Fast, responsive, SEO-ready marketing sites engineered to rank, load instantly and convert visitors into customers — built on a solid technical foundation from day one.",
  },
  {
    icon: ShoppingCart,
    color: "#06b6d4",
    bg: "rgba(6,182,212,0.10)",
    t: "E-commerce & WooCommerce",
    d: "Conversion-tuned storefronts with optimised checkout flows, product discovery and performance at any scale — from boutique shops to high-volume catalogues.",
  },
  {
    icon: Palette,
    color: "#f59e0b",
    ...
    d: "Bespoke design systems rooted in your brand identity — not templates. Every component is crafted in Figma and refined until it feels unmistakably yours.",
  },
  {
    icon: Code2,
    color: "#10b981",
    ...
    d: "Custom themes, bespoke plugins, Gutenberg blocks and complex third-party integrations — every WordPress build is headless-ready and editor-friendly.",
  },
  {
    icon: Gauge,
    color: "#ec4899",
    bg: "rgba(236,72,153,0.10)",
    t: "Performance & Core Web Vitals",
    d: "Sub-second loads, perfect Lighthouse scores and optimised CWV — because speed is a conversion strategy, not a technical afterthought.",
  },
  {
    icon: Shield,
    color: "#f43f5e",
    bg: "rgba(244,63,94,0.10)",
    t: "Accessibility (WCAG 2.2)",
    d: "Inclusive, keyboard-navigable, screen-reader tested experiences that meet WCAG 2.2 AA — expanding your audience and reducing legal exposure.",
  },
];
...
const testimonials = [
  {
    ...
    quote: "Our new site loads in under a second and our conversion rate jumped 40% in the first month. The team's attention to detail — from animations to accessibility — is genuinely elite.",
  ...
  },
  {
    name: "Sarah Lin",
    role: "CTO, NorthPeak",
    quote: "We moved from a sluggish WordPress theme to a custom Next.js build. The difference is night and day — both for our users and for our developers maintaining it.",
  ...
  },
  {
    ...
    quote: "The Figma design system they built has transformed how fast we can iterate. We launch new landing pages in hours, not weeks — and they look consistent every time.",
...
const faqs = [
  {
    ...
    a: "Yes — we manage deployment and hosting on Vercel, Cloudflare Pages, AWS or your existing infrastructure. We configure CI/CD pipelines, custom domains, SSL and CDN so you have nothing to worry about on launch day.",
  },
  {
    q: "Can you maintain the site after launch?",
    a: "Absolutely. Monthly retainers cover ongoing updates, security patches, content changes and growth experiments like A/B testing and CRO. Many clients keep us on indefinitely as their embedded web team.",
  },
  {
    q: "We already have a site — can you improve it rather than rebuild?",
    a: "Yes, and often that's the right call. We'll audit your existing site, identify the highest-impact improvements and scope a targeted optimisation engagement. A full rebuild is only recommended when the architecture genuinely can't support your goals.",
  },
  {
    q: "How do you approach mobile and responsive design?",
    a: "Every project is designed and built mobile-first. We test across real devices — not just browser emulators — and optimise for touch interactions, viewport sizing and mobile Core Web Vitals separately from desktop.",
  },
  {
    q: "Do you build on page builders like Elementor or Divi?",
    a: "We don't use drag-and-drop page builders for production builds — they introduce performance and maintenance overhead that compounds over time. We build custom Gutenberg blocks or headless frontends that give you full editorial control without the bloat.",
  },
  {
    q: "What's included in the Figma design system?",
    a: "Design tokens (colours, typography, spacing), a full component library documented with usage notes, responsive layouts for every key page and a brand style guide. We also run a handoff session so your team can use and extend the system independently.",
  },
];
  ...
  return (
    <Layout>
      ...
      <section ref={heroRef} className="relative overflow-hidden min-h-[78vh] flex items-center">
        ...
        {/* Indigo accent for web/dev theme */}
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <motion.h1 initial={{ opacity: 0, y: 28 }} animate={{ opacity: 1, y: 0 }}
                  ...
                  Websites that{" "}
                  <span className="gradient-text">convert and scale.</span>
                </motion.h1>

                <motion.p initial={{ opacity: 0, y: 14 }} animate={{ opacity: 1, y: 0 }}
                  transition={{ duration: 0.6, delay: 0.25, type: "tween", ease: "easeOut" }}
                  className="mt-6 text-lg text-muted-foreground leading-relaxed max-w-lg">
                  From marketing sites to high-traffic e-commerce — we design and build web
                  experiences engineered for performance, SEO and long-term growth.
                </motion.p>
        ...
        <motion.div {...fadeUp()} className="mb-14">
          ...
          <div className="flex items-end justify-between flex-wrap gap-4">
            <h2 className="text-4xl md:text-5xl font-bold">
              Every web capability,<br />under one roof.
            </h2>
          ...
          <motion.div {...fadeUp(0.1)}>
            <div className="glass border border-border/35 rounded-2xl p-8 h-full">
              ...
              <p className="text-sm text-muted-foreground mb-7 leading-relaxed">
                We choose frameworks based on your project's requirements — not trends. Every stack decision is documented with clear trade-offs so you're never locked in.
              </p>
              ...
              <div className="mt-8 flex items-start gap-3 p-4 bg-primary/5 border border-primary/15 rounded-xl">
                ...
                <p className="text-xs text-muted-foreground leading-relaxed">
                  <span className="text-foreground font-semibold">Performance by default.</span>{" "}
                  Every build is measured against Core Web Vitals and Lighthouse before launch. We don't ship until the numbers are right.
                </p>
              </div>
            </div>
          </motion.div>
      ...
      <section className="mx-auto max-w-7xl px-4 py-20">
        <motion.div {...fadeUp()} className="text-center max-w-2xl mx-auto mb-18">
          ...
          <h2 className="text-4xl md:text-5xl font-bold">
            From brief to live site —<br />five clear steps.
          </h2>
          <p className="mt-4 text-muted-foreground text-sm">
            A structured build process refined across 180+ web projects.
          </p>
        </motion.div>
      ...
      <section className="mx-auto max-w-4xl px-4 py-16">
        <motion.div {...fadeUp()} className="text-center mb-12">
          ...
          <h2 className="text-4xl md:text-5xl font-bold">
            Common questions<br />about web development.
          </h2>
        ...
        <motion.div {...fadeUp()}
          ...
          <div className="absolute inset-0 pointer-events-none overflow-hidden">
            <svg className="absolute inset-0 w-full h-full opacity-[0.06]" xmlns="http://www.w3.org/2000/svg">
              <defs>
                <pattern id="cta-grid-webdev" width="32" height="32" patternUnits="userSpaceOnUse">
                  <path d="M 32 0 L 0 0 0 32" fill="none" stroke="white" strokeWidth="0.5" />
                </pattern>
              </defs>
              <rect width="100%" height="100%" fill="url(#cta-grid-webdev)" />
            </svg>
          ...
          <div className="relative flex flex-col md:flex-row items-center justify-between gap-8 px-8 py-10 md:px-12">
            <div className="flex-1 text-left">
              ...
              <h2 className="text-2xl md:text-3xl font-bold text-white leading-snug">
                Ready to build a website<br className="hidden md:block" /> that actually performs?
              </h2>
