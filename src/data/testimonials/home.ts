...
export const homeTestimonials: HomeTestimonial[] = [
  ...
  },
  {
    ...
    role: "CEO, Pinnacle Properties Dubai",
    quote:
  ...
  {
    name: "James Okafor",
    role: "Co-founder, Vestro Capital",
    quote:
  ...
  {
    name: "Nour Khalil",
    role: "Content Manager, Gulf Media Network",
    quote:
  ...
  {
    name: "Priya Menon",
    role: "E-commerce Director, Saffron Living",
    quote:
  ...
  {
    name: "Tom Aldridge",
    role: "Head of Growth, ClearRoute SaaS",
    quote:
