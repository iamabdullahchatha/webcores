...
const appCss = "/assets/styles-D7li9G4y.css";
...
const Route$b = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Premium software, web & IT solutions for global businesses." },
      { name: "author", content: "Webcore Solutions" },
      { property: "og:title", content: "Webcore Solutions" },
      { property: "og:description", content: "Software, Web & IT Solutions for Global Businesses." },
...
const $$splitComponentImporter$a = () => import("./faqs-BQN7GDux.js");
const Route$a = createFileRoute("/faqs")({
  head: () => ({
    meta: [{
      title: "FAQs — Webcore Solutions"
    }, {
      name: "description",
      content: "Answers to common questions about our process, pricing and partnerships."
    }, {
      property: "og:title",
      content: "FAQs — Webcore Solutions"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$a, "component")
});
const $$splitComponentImporter$9 = () => import("./contact-CyWo1cwU.js");
const Route$9 = createFileRoute("/contact")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Get in touch with Webcore Solutions. UK, Dubai and global support."
    }, {
      property: "og:title",
...
const $$splitComponentImporter$8 = () => import("./about-ChLWkwsd.js");
const Route$8 = createFileRoute("/about")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Founded in Dubai by Muhammad Abdullah Chattha. Serving Europe, UK, America, Dubai & Pakistan."
    }, {
      property: "og:title",
      content: "About Webcore Solutions"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./index-Cygu5mv3.js");
const Route$7 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Premium software, web & IT solutions for global businesses. Founded in Dubai, serving Europe, UK, America & Pakistan."
    }, {
      property: "og:title",
      content: "Webcore Solutions"
    }, {
...
const $$splitComponentImporter$6 = () => import("./services.index-u6akxg8n.js");
const Route$6 = createFileRoute("/services/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "IT consultation, web & software development, SEO, GEO and graphic design."
    }, {
      property: "og:title",
      content: "Services — Webcore Solutions"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./services.web-development-BUh0jMZR.js");
const Route$5 = createFileRoute("/services/web-development")({
  head: () => ({
    meta: [{
      title: "Web Development — Webcore Solutions"
    }, {
      name: "description",
      content: "Business websites, e-commerce, custom design and WordPress development."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./services.software-development-ChkCZGYu.js");
const Route$4 = createFileRoute("/services/software-development")({
  head: () => ({
    meta: [{
      title: "Software Development — Webcore Solutions"
    }, {
      name: "description",
      content: "Custom software and data management systems engineered to scale."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./services.seo-geo-Bgn7OtGm.js");
const Route$3 = createFileRoute("/services/seo-geo")({
  head: () => ({
    meta: [{
      title: "SEO & GEO — Webcore Solutions"
    }, {
      name: "description",
      content: "Rank higher locally and globally — organically and sustainably."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./services.it-consultation-BuCgeED_.js");
const Route$2 = createFileRoute("/services/it-consultation")({
  head: () => ({
    meta: [{
      title: "IT Consultation — Webcore Solutions"
    }, {
      name: "description",
      content: "Strategic technology guidance, audits and roadmaps for scaling teams."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./services.graphic-design-BOt98y5C.js");
const Route$1 = createFileRoute("/services/graphic-design")({
  head: () => ({
    meta: [{
      title: "Graphic Design — Webcore Solutions"
    }, {
      name: "description",
      content: "Logos, brochures, company profiles, visiting cards and brand systems."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./services.cms-development-CJYLdxk0.js");
const Route2 = createFileRoute("/services/cms-development")({
  head: () => ({
    meta: [{
      title: "CMS Development — Webcore Solutions"
    }, {
      name: "description",
      content: "Custom-fit content platforms built to evolve with your team."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter, "component")
});
const FaqsRoute = Route$a.update({
  id: "/faqs",
  path: "/faqs",
...
const ServicesWebDevelopmentRoute = Route$5.update({
  id: "/services/web-development",
  path: "/services/web-development",
  getParentRoute: () => Route$b
});
const ServicesSoftwareDevelopmentRoute = Route$4.update({
  id: "/services/software-development",
  path: "/services/software-development",
  getParentRoute: () => Route$b
});
const ServicesSeoGeoRoute = Route$3.update({
  id: "/services/seo-geo",
  path: "/services/seo-geo",
  getParentRoute: () => Route$b
});
const ServicesItConsultationRoute = Route$2.update({
  id: "/services/it-consultation",
  path: "/services/it-consultation",
  getParentRoute: () => Route$b
});
const ServicesGraphicDesignRoute = Route$1.update({
  id: "/services/graphic-design",
  path: "/services/graphic-design",
  getParentRoute: () => Route$b
});
const ServicesCmsDevelopmentRoute = Route2.update({
...
const rootRouteChildren = {
  ...
  ContactRoute,
  FaqsRoute,
  ServicesCmsDevelopmentRoute,
  ServicesGraphicDesignRoute,
  ServicesItConsultationRoute,
  ServicesSeoGeoRoute,
